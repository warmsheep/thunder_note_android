...
@Database(entities = {PendingMessage.class, FlashNoteLocalEntity.class, MessageLocalEntity.class, FavoriteLocalEntity.class, CollectionLocalEntity.class}, version = 10, exportSchema = false)
