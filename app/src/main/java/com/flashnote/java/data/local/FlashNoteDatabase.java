...
@Database(entities = {PendingMessage.class, FlashNoteLocalEntity.class, MessageLocalEntity.class, FavoriteLocalEntity.class, CollectionLocalEntity.class}, version = 8, exportSchema = false)
